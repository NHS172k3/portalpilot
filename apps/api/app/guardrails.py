...
def classify_human_only(action_text: str) -> AgentRequestDraft | None:
    ...
    return AgentRequestDraft(
        ...
        prompt="Log in, complete authentication/MFA/CAPTCHA if required, and clear any declaration, submission, endorsement, or payment step yourself. Then return here to resume the agent.",
